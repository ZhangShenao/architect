...
import william.kafka.deserializer.UserDeserializer;
import william.kafka.rebalance.SimpleRebalanceListener;
 ...
 * @Description:指定反序列化器
 */
public class AssignDeserializerConsumer {
    public static void main(String[] args) {
        Properties props = new Properties();
        props.put(BOOTSTRAP_SERVERS_CONFIG, "localhost:9092");
        props.put(KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        props.put(VALUE_DESERIALIZER_CLASS_CONFIG, UserDeserializer.class);
        ...
        consumer.subscribe(Collections.singletonList(TOPIC_NAME),new SimpleRebalanceListener());
