...
import static william.kafka.constant.KafkaConstants.CONSUMER_GROUP_2;
import static william.kafka.constant.KafkaConstants.TOPIC_NAME;

/**
 * @Author: ZhangShenao
 * @Date: 2019/6/16 10:18
 * @Description:ConsumerGroup2 ConsumerA
 */
public class Group2ConsumerA {
    public static void main(String[] args) {
        Properties props = new Properties();
        props.put(BOOTSTRAP_SERVERS_CONFIG, "localhost:9092");
        props.put(KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        props.put(VALUE_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        props.put(GROUP_ID_CONFIG, CONSUMER_GROUP_2);
