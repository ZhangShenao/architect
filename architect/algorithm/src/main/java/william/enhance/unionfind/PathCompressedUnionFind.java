 ...
 * @Description:基于路径压缩的并查集
 */
public class PathCompressedUnionFind implements UnionFind {
    ...
    public PathCompressedUnionFind(int capacity) {
    ...
    @Override
    public String name() {
        return "PathCompressedUnionFind";
    }
}
